...
int segons = 100;          // velocitat de l'acció en ms
...
void loop()
{
 ...
 Serial.println (valLdr2);
  ...
  valLdr0 = map(valLdr0, 670, 157,0 , 255);   // mapejar valor de 0-1023 a 0-255
  valLdr1 = map(valLdr1, 688, 215, 0, 255);   // mapejar valor de 0-1023 a 0-255
  valLdr2 = map(valLdr2, 690, 255, 0, 255);   // mapejar valor de 0-1023 a 0-255
